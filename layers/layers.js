...
//ol.proj.get("EPSG:4326").setExtent([18.490778, -24.409971, 39.401842, -13.662914]);
var wms_layers = [];
...
lyr_IrrigationSchemeSites_3.set('fieldAliases', {'fid': 'fid', 'Scheme': 'Scheme', 'Province': 'Province', 'District': 'District', 'Ward': 'Ward', 'Water_Sour': 'Water Source', 'Status': 'Status', 'Total_ha_': 'Total Area (Ha)', 'html_exp': 'Photos', 'completion': 'Completion', 'scheme-sta': 'scheme-sta', });
...
lyr_IrrigationSchemeSites_3.set('fieldImages', {'fid': 'Hidden', 'Scheme': 'TextEdit', 'Province': 'TextEdit', 'District': 'TextEdit', 'Ward': 'Hidden', 'Water_Sour': 'TextEdit', 'Status': 'TextEdit', 'Total_ha_': 'TextEdit', 'html_exp': 'ExternalResource', 'completion': 'Hidden', 'scheme-sta': 'TextEdit', });
lyr_NationalProvincialboundaries_1.set('fieldLabels', {'POPU_M': 'hidden field', 'POPU_F': 'hidden field', });
lyr_GCFDistricts_2.set('fieldLabels', {'area': 'no label', });
lyr_IrrigationSchemeSites_3.set('fieldLabels', {'Scheme': 'header label - visible with data', 'Province': 'header label - visible with data', 'District': 'header label - visible with data', 'Water_Sour': 'header label - visible with data', 'Status': 'header label - visible with data', 'Total_ha_': 'header label - visible with data', 'html_exp': 'header label - visible with data', 'scheme-sta': 'no label', });
