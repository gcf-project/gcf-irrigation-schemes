...
map.getView().fit([18.490778, -24.409971, 39.401842, -13.662914], map.getSize());
    ...
    element: (() => {
        ...
        if (83 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map shows the distribution and progress of GCF Irrigation Schemes in Zimbabwe.<br />';
            }
